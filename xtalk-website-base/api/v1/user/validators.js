...
exports.validateUpdate = function (req, callback) {
  ...
  // req.checkBody('user.phone','phone required').notEmpty();
  let user=JSON.parse(req.body.user);
  var data = _.pick(user, ['id','gender','age', 'orientation', 'about','location','phone','service','languages','doNotDisturb','interests','specialities','firstName','lastName','email', 'category']);
  data = _.each(data, function (o) {
    _.each(o, function (v, k) {
