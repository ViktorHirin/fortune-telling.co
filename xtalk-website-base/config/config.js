...
var initGlobalConfigFiles = function (config, assets) {
  ...
  config.files.server.handleEvents = getGlobbedPaths(assets.server.handleEvents);
...
var initGlobalConfig = function () {
  ...
  config = _.merge(config, (fs.existsSync(path.join(process.cwd(), 'config/env/' + process.env.NODE_ENV + '.js')) && require(path.join(process.cwd(), 'config/env/' + process.env.NODE_ENV + '.js'))) || {});
